  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.danhao" label="单号" prop="danhao">
              <el-input v-model="ruleForm.danhao" 
                placeholder="单号" readonly></el-input>
          </el-form-item>
        </div>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.$http({
              url: `option/yongdianqingkuang/xueshengzhanghao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
    ...
    xueshengzhanghaoChange () {
      this.$http({
        url: `follow/yongdianqingkuang/xueshengzhanghao?columnValue=`+ this.ruleForm.xueshengzhanghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                ...
                this.ruleForm.xueshengxingming = data.data.xueshengxingming
                                                ...
                                                if(data.data.loucenghao){
                this.ruleForm.loucenghao = data.data.loucenghao
              }
                                                if(data.data.yongdianliang){
                this.ruleForm.yongdianliang = data.data.yongdianliang
              }
                                                if(data.data.jine){
